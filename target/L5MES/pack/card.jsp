...
<footer>
   ...
   <c:choose>
       <c:when test="${workcard.processFlowCard.cardNo!=null && workcard.processFlowCard.cardNo!='' }">
           <button class="wg button_info" onclick="location.href='../pack/create?stepID=${WorkStep.id}'"><%--<img src="../img/bz.png" alt="">--%>包装汇报</button>
           <button class="yc button_info" onclick="location.href='../exception/create?stepID=${WorkStep.id}'"><%--<img src="../img/yc.png" alt="">--%>异常汇报</button>
       </c:when>
       <c:otherwise>
           <button class="wg button_info" style="background: #dbdbdb !important;" disabled><%--<img src="../img/bz.png" alt="">--%>包装汇报</button>
